...
@section('content')
                <article class="content_box">
                    ...
                    <div class="head">
                        ...
                        <i class="far fa-map" aria-hidden="true"></i><b>Post Exam Results</b>
                    </div>
                    <ul class="ul1">
                        <form method="POST" action="{{ route('teacher.exam_result') }}">
                            @csrf
                            ...
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row1e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row2e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row3e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row4e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row5e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row6e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row7e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row8e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row9e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row10e"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="row11e"/></td>
                                </tr>
                                <tr>
                                    <td>12</td>
                                    ...
                                    <td><input type="text" name="row12e"/></td>
                                </tr>
                                <tr>
                                    <td>13</td>
                                    ...
                                    <td><input type="text" name="row13e"/></td>
                                </tr>
                                <tr>
                                    <td>14</td>
                                    ...
                                    <td><input type="text" name="row14e"/></td>
                                </tr>
                                <tr>
                                    <td>15</td>
                                    ...
                                    <td><input type="text" name="row15e"/></td>
                                </tr>
                            </table>
                ...
                <ul>
                    ...
                    <li>
                        <h5>
                            ...
                            <a style="text-decoration:none" href="{{ route('teacher.exam_result.show', ['id' => $row->name]) }}">{{ $row->name }}</a>
                        </h5>
                    </li>
                    @endforeach
                </ul>
